...
import dms.pastor.prototype.dcs.utils.random.RandomUtils;
...
import static dms.pastor.prototype.dcs.conditions.ConditionGroup.NEGATIVE;
...
public class Condition {
    ...
    static Condition createCondition(ConditionEntry... conditionEntries) {
        ...
        if (ConditionEntry.isEmpty(conditionEntries)) {
            return condition;
        }
    ...
    boolean isImmuneTo(ElementType type) {
        ...
        switch (type) {
            case AIR:
                return isImmuneTo(ConditionType.AIR_IMMUNE, ConditionType.AIR_RESISTANT);
            case EARTH:
                return isImmuneTo(ConditionType.EARTH_IMMUNE, ConditionType.EARTH_RESISTANT);
            case FIRE:
                return isImmuneTo(ConditionType.FIRE_IMMUNE, ConditionType.FIRE_RESISTANT);
            case WATER:
                return isImmuneTo(ConditionType.WATER_IMMUNE, ConditionType.WATER_RESISTANT);
            default:
