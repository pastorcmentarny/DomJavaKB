"""
Idea:
- 1 played 10 games ago
- 1 played 2-9 games ago
- 1 random
- 2 playing most often that didn't play for at least 4 games
- 1 random but didn't play last time
"""
import itertools
import random
import webbrowser
...
def generate_numbers_for_lotto():
    ...
    n6 = int(str(random.randint(1, 60)))
    ...
    return f"Numbers to play are : {next_draw_number}"


def generate_numbers_for_lotto_old():
    global n1, n2, n3, n4
