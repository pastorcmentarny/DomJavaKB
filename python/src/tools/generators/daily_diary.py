...
TITLE_RUN_DISTANCE = 'How much I ran ?[0. no] [1. 2km] [2. 2.5-4.99km] [3. 5km-8.5km] 94. More than 8.5km]?'
...
def evening():
    ...
    hr = '=' * 50 + '\n'
    daily_counter_and_total = f'{daily_task_counter} of {daily_task_total}'
