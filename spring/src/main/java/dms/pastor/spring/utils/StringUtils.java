...
public final class StringUtils {
    ...
    static final String ALPHABET_BOTH_CASE = ALPHABET + ALPHABET.toUpperCase();
    ...
    private static final String INPUT_CANNOT_BE_EMPTY = "Input can not be empty!";

    private StringUtils() {
    }

    public static Map<Character, Integer> getAlphabetAsMap() {
    ...
    public static String getCurrentDateWithTimeAsString() {
        String temp;
        Date date = new Date();
    ...
    static String[] toStringArray(List<String> arrayList) {
        if (arrayList == null) {
    ...
    public static boolean verifyThatAllKeywordsExists(List<String> keywords, String text) {
    ...
    public static String removeAllNonAlphaNumericCharactersFromString(String string) {
    ...
    //TODO complete this exercise
    public static boolean endsWithIgnoringCase(String string, String sufix) {
        if (isStringEmpty(string)) {
            return false;
        }
        return false;
    ...
    public static int countOccurrenceOf(String occurrence, String string) {
        ...
        final int counter = string.toLowerCase().split(occurrence).length - 1;
