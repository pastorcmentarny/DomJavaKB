...
public class CoupleOperationsTest {
    ...
    public void deleteDiscardedCouplesShouldDelete2Items() throws Exception {
        ...
        final Set<Couple> coupleSet = new HashSet<>();
        coupleSet.addAll(asList(couple1,couple2,couple3,couple4));

        final Set<Couple> coupleToDeleteSet = new HashSet<>();
        coupleToDeleteSet.addAll(asList(couple3,couple4));
