...
public class MainGameGUI extends javax.swing.JFrame {
    ...
    private javax.swing.JButton beserkAttack;
    ...
    private void initComponents() {
        ...
        beserkAttack = new javax.swing.JButton();
        ...
        beserkAttack.setText("Beserk Attack");
        beserkAttack.setEnabled(false);
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(beserkAttack, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void RunTurnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RunTurnActionPerformed
        ...
        if (isIt) {
            int Edmg = battle.EnemyAttack(player, enemy, lvl, console);
            antyexp += Edmg;
            console.setText(console.getText() + "\nPlayer does " + Edmg + " damage!");
            player.PlayerShield -= Edmg;
    ...
    private void endOfBattle() {
        player.kills++;
        console.setText("You kill " + player.kills + " unit" + isPlular());
        RunTurn.setEnabled(false);
    ...
    private void isLevelUpForSomebody() {
        if (antyexp >= 1000) {
            antyexp -= 1000;
            lvl++;
            console.setText("Enemy level up! Currect level:" + lvl);
        }
        if (player.exp >= 1000) {
            player.levelUp();
            updateConsole();
    ...
    private void endOfTurn() {
        ...
        player.status.decreseLengthOfPoison();
