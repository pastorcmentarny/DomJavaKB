...
public class Config {
    ...
    public static final int FIREBALL_DMG = 5;
    public static final int ICE_BOLT_DMG = 2;
    public static final int REGEN_HP_PER_TURN = 1;
    public static final int HEAL = 3;
    public static final int METEOR_STRIKE_NO = 6;
    public static final int METEOR_STRIKE_DMG = 3;
    public static final int MAGIC_STONE_DMG = 1;
    public static final int INFERNO_STRIKE_NO = 10;
    public static final int INFERNO_STRIKE__DMG = 1;
    public static final int LIGHTING_BOLT_DAMAGE = 3;
